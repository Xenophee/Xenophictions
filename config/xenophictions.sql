...
(1, 'Prologue', 1, 'En attente...', '2023-04-10 21:55:08', NULL, NULL, NULL, 1),
(2, 'Chapitre I - Le revenant', 2, 'En attente...', '2023-04-10 22:13:44', NULL, NULL, NULL, 1),
(3, 'Chapitre II - L&#39;avertissement', 3, 'En attente...', '2023-04-10 22:37:02', NULL, NULL, NULL, 1),
(4, 'Chapitre III - La rencontre', 4, 'En attente...', '2023-04-10 22:43:09', NULL, NULL, NULL, 1),
(5, 'Chapitre IV - La chute', 5, 'En attente...', '2023-04-10 22:47:15', NULL, NULL, NULL, 1),
...
--
ALTER TABLE `chapters`
  MODIFY `id_chapters` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `notes`
  MODIFY `id_notes` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `sections`
  MODIFY `id_sections` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `saves`
  ADD CONSTRAINT `saves_ibfk_1` FOREIGN KEY (`id_sections`) REFERENCES `sections` (`id_sections`),
  ADD CONSTRAINT `saves_ibfk_2` FOREIGN KEY (`id_users`) REFERENCES `users` (`id_users`);
