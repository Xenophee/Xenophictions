                ...
                <section class="d-flex flex-column align-items-center px-5">
                    ...
                    <form class="formStories" method="POST" novalidate>
                            ...
                            <div>
                                ...
                                <select class="form-select" name="chapter" id="chapter">
                                    ...
                                    <?php foreach ($chapters as $chapter) {
                                        echo "<option value=\"$chapter->id_chapters\">$chapter->title</option>";
                                    } ?>
                                </select>
                        ...
                        <div class="d-flex flex-column align-items-center my-5">
                            ...
                            <input type="text" class="form-control" id="title" name="title" value="<?= htmlentities($title ?? $section->title) ?>">
                        ...
                        <div class="mb-5">
                            <label for="description" class="form-label d-flex justify-content-center">Description *
                                :</label>
                            <textarea class="form-control" id="description" name="description" required><?= htmlentities($description ?? $section->description) ?></textarea>
                        ...
                        <div class="mb-5">
                            <label for="content" class="form-label d-flex justify-content-center">Contenu *
                                :</label>
                            <textarea class="form-control" id="content" name="content" required><?= htmlentities($content ?? $section->content) ?></textarea>
