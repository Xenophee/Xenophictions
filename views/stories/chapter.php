        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-around mt-4">
                <div class="col-11 d-flex justify-content-between align-items-center">
                    <a href="" title="Revenir au sommaire"><i class="bi bi-arrow-left"></i></a>
            ...
            <div class="row justify-content-center align-items-stretch">
                <div class="col-11 col-md-9 col-xl-7">
                    <h1 class="text-center">Titre de l'oeuvre</h1>
                    <h2 class="text-center my-5">Titre du chapitre</h2>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-11 col-md-8 d-flex flex-wrap justify-content-evenly">
                    <a href="" class="btn btnChoice my-3">Tenter la diplomatie</a>
                    <a href="" class="btn btnChoice my-3">Le menacer en pointant l'arme sur lui</a>
                    <a href="" class="btn btnChoice my-3">Lui tirer dessus avec l'arme</a>
                </div>
            </div>
